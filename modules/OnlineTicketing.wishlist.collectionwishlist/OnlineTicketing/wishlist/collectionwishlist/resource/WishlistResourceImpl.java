...
public class WishlistResourceImpl extends WishlistResourceDecorator {
  ...
  public Wishlist createWishlist(VMJExchange vmjExchange) {
    ...
    Wishlist wishlistdeco = WishlistFactory.createWishlist(
        "OnlineTicketing.collectionwishlist.core.WishlistImpl", wishlist, collectionimpl);
    return wishlistdeco;
  }
  ...
  public Wishlist createWishlist(VMJExchange vmjExchange, int id) {
    ...
    wishlist = record.createWishlist(vmjExchange);
    Wishlist wishlistdeco = WishlistFactory.createWishlist(
        "OnlineTicketing.collectionwishlist.core.WishlistImpl", id, wishlist, collectionimpl);
    return wishlistdeco;
  }
