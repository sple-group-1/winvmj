...
public abstract class PackageOptionResourceDecorator extends PackageOptionResourceComponent{
	protected PackageOptionResourceComponent record;

    public PackageOptionResourceDecorator(PackageOptionResourceComponent record) {
        this.record = record;
    }
