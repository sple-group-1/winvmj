...
INSERT INTO cartitem_comp (id, amount, enddate, quantity, startdate, bookingitem_id, cart_id, modulesequence, objectname) VALUES
('f2c3f5a7-2a14-4a7d-a408-5a8b82df178e', 100000, '2025-5-13', 10, '2025-5-1', '2ea9ff33-6dd2-4c0a-b113-a90ee32a01ca', '3d0c98d4-3e48-4d4f-8df2-f15c7a3ea229', 'cartitem_impl', 'OnlineTicketing.cart.core.CartItemImpl')
ON CONFLICT DO NOTHING;
